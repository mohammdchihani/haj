...
final formkeypassadmin = GlobalKey<FormState>();

class textfiledadminepassword extends StatefulWidget {
  final String? text;
...
// Add formKey parameter
  ...
  @override
  _textfiledadminepasswordState createState() => _textfiledadminepasswordState();
}

class _textfiledadminepasswordState extends State<textfiledadminepassword> {
