...
class CustomEmailField5 extends StatefulWidget {
  final String? text;
  ...
  @override
  _CustomEmailField5State createState() => _CustomEmailField5State();
}

class _CustomEmailField5State extends State<CustomEmailField5> {
