...
final formkeypass50 = GlobalKey<FormState>();

class Custom5pass extends StatefulWidget {
  final String? text;
...
// Add formKey parameter
  ...
  @override
  _Custom5passState createState() => _Custom5passState();
}

class _Custom5passState extends State<Custom5pass> {
